...
const addBook = async (req, res, next) => {
    ...
    try {
        const book = new Book({ name, author, description, price, availability, image });
        await book.save();
...
const updateBook = async (req, res, next) => {
    ...
    const { name, author, description, price, availability, image } = req.body;
    try {
        const book = await Book.findByIdAndUpdate(id, { name, author, description, price, availability, image }, { new: true });
